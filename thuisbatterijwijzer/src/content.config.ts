...
const thuisbatterijen = defineCollection({
  loader: glob({ pattern: '**/*.md', base: './src/content/thuisbatterijen' }),
  schema: articleSchema,
});

export const collections = { thuisbatterijen };
